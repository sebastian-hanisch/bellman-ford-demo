"""SETTING_SPECS-Permalink-Muster, Presets und Zufalls-Seed-Button (Standardmuster aus dem Demo-Portfolio, siehe ch_presets.py in contraction-hierarchies-demo)."""
...
SETTING_SPECS = {
    ...
    "variant_select": SettingSpec("var", _choice(tuple(C.VARIANT_LABELS)), C.DEFAULT_VARIANT),
    "order_select": SettingSpec("order", _choice(tuple(C.ORDER_LABELS)), C.DEFAULT_EDGE_ORDER),
...
PRESET_KEYS = {"net": "net_select", "side": "side_slider", "hill": "hill_slider", "eta": "eta_slider", "reach": "reach_slider", "spread": "spread_slider", "nodes": "nodes_slider", "degree": "degree_slider",
               "pot": "pot_slider", "variant": "variant_select", "order": "order_select", "seed": "seed_input"}
# Regler, die je nach Netz oder Variante ausgeblendet sind: Streamlit löscht ihren Zustand, sobald sie nicht gezeichnet werden - der zuletzt gewählte Wert bleibt hier erhalten
KEPT = {key: f"_kept_{key}" for key in ("side_slider", "hill_slider", "eta_slider", "reach_slider", "spread_slider", "nodes_slider", "degree_slider", "pot_slider", "order_select", "seed_input")}
